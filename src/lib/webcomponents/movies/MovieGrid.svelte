		...
		<div class="mb-6">
			...
			<div class="mb-4 flex items-center justify-between">
				<button
					...
					class="flex items-center gap-2 rounded-lg bg-slate-800 px-4 py-2 text-white transition-colors hover:bg-slate-700"
				>
					...
					Filters & Sort
					{#if hasFilters}
						<span class="rounded-full bg-blue-600 px-2 py-1 text-xs">Active</span>
					{/if}
				</button>
			...
			<!-- Filters Panel -->
			{#if showFilters}
				<div class="rounded-lg border border-slate-700/50 bg-slate-800/50 p-6 backdrop-blur-sm">
					<div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
						...
						<div>
							...
							<select
								id="sort-by-select"
								bind:value={sortBy}
								class="w-full rounded-lg border border-slate-600 bg-slate-700 px-3 py-2 text-white focus:border-transparent focus:ring-2 focus:ring-blue-500"
							>
						...
						<!-- Sort Order -->
						<div>
							<label for="sort-order-select" class="mb-2 block text-sm font-medium text-gray-300"
								>Order</label
							>
							<select
						...
						<!-- Minimum Rating -->
						<div>
							<label for="min-rating-slider" class="mb-2 block text-sm font-medium text-gray-300">
						...
						<!-- Release Year -->
						<div>
							<label for="release-year-select" class="mb-2 block text-sm font-medium text-gray-300"
								>Release Year</label
							>
							<select
