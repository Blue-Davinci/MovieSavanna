...
<svelte:head>
  ...
  <meta name="description" content="Sign in to your MovieSavanna account to access unlimited movies and TV shows." />
</svelte:head>
...
<div class="min-h-screen flex bg-slate-950 relative overflow-hidden" transition:fly|global={{ y: -200, duration: 300 }}>
  ...
  <div class="absolute inset-0 opacity-10">
    ...
    <div class="absolute top-40 right-20 w-72 h-72 bg-purple-500 rounded-full mix-blend-multiply filter blur-xl animate-pulse animation-delay-2000"></div>
    <div class="absolute bottom-20 left-40 w-72 h-72 bg-pink-500 rounded-full mix-blend-multiply filter blur-xl animate-pulse animation-delay-4000"></div>
  </div>
      ...
      <div class="space-y-8">
        <div>
          ...
          <p class="text-xl text-gray-300 leading-relaxed mb-8">
            Stream unlimited movies and TV shows in stunning 4K quality. Your entertainment journey continues here with personalized recommendations just for you.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6">
          <div class="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
            ...
            <div>
              ...
              <p class="text-gray-300 text-sm">Access thousands of movies and shows</p>
            </div>
          </div>
          ...
          <div class="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
            ...
            <div>
              ...
              <p class="text-gray-300 text-sm">Crystal clear quality on any device</p>
            </div>
          </div>
          ...
          <div class="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
            ...
            <div>
              ...
              <p class="text-gray-300 text-sm">Watch anywhere, even without internet</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="flex flex-col w-full lg:w-1/2 relative" in:fade={{ duration: 300 }}>
    ...
    <div class="absolute top-8 left-8 z-10">
      <button
        ...
        class="flex items-center gap-2 text-gray-400 hover:text-blue-400 transition-all duration-300 bg-slate-900/50 backdrop-blur-sm rounded-lg px-4 py-2 border border-slate-700 hover:border-blue-500"
      >
        ...
        <div class="bg-slate-900/50 backdrop-blur-xl rounded-2xl p-8 border border-slate-700 shadow-2xl">
          ...
          <div class="text-center mb-8">
            <a href="/" aria-label="MovieSavanna home page" class="inline-flex items-center mb-6 group">
              <span class="text-blue-500 font-bold text-3xl mr-1 group-hover:text-blue-400 transition-colors">Movie</span>
          ...
          <div class="bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-lg p-4 mb-6">
            <div class="flex items-start gap-3">
              <div class="w-8 h-8 bg-blue-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div class="flex-1">
                <p class="text-blue-400 text-sm font-medium mb-1">🎬 Demo Account Available</p>
                <p class="text-blue-300 text-xs mb-3">Try: demo@moviesavanna.com / Demo123!</p>
                <button
                  type="button"
                  onclick={fillDemoCredentials}
                  class="bg-blue-500/20 hover:bg-blue-500/30 text-blue-400 text-xs px-3 py-1 rounded-md transition-colors"
                >
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <input
                  ...
                  class="w-full px-4 py-3 bg-slate-800/50 border border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder-gray-500 transition-all duration-300 backdrop-blur-sm"
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                <input
                  ...
                  class="w-full px-4 py-3 bg-slate-800/50 border border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder-gray-500 transition-all duration-300 backdrop-blur-sm pr-12"
    ...
    <footer class="text-center text-sm text-gray-500 p-8">
      ...
      <div class="flex justify-center space-x-4 mt-2">
        <a href="/terms" class="text-blue-400 hover:text-blue-300 transition-colors">Terms</a>
        <span>•</span>
        <a href="/privacy" class="text-blue-400 hover:text-blue-300 transition-colors">Privacy</a>
        <span>•</span>
        <a href="/help" class="text-blue-400 hover:text-blue-300 transition-colors">Help</a>
      </div>
    </footer>
  </div>
</div>
